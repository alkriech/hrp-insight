...
try {
  ...
  await db.prepare("UPDATE workspace SET privacy_contact=? WHERE id=?").bind('hrpinstrumen@gmail.com', 'hrp-insight').run();

  const privacySnapshot = JSON.stringify({ name: workspace.name, privacy_notice: workspace.privacy_notice, privacy_contact: 'hrpinstrumen@gmail.com', retention_days: workspace.retention_days });
  ...
  const TRAININGS = [
    ...
    },
    {
      ...
      details: { timezone: 'WIB', method: 'Offline', scheme: 'Komersil', duration: 1320, category: 'Kepemimpinan', grade_level: 'Guru', organizer: 'HRP Insight', price: 950000, participant_count: 90, pic: 'Angga Saputra', moderator: 'Dewi Lestari', registration_link: 'https://forms.hrp-insight.test/elevate-kepemimpinan', content_link: 'https://drive.hrp-insight.test/elevate-lead', description: 'Kelas pengembangan kepemimpinan bagi instruktur dan calon fasilitator.' },
      access: [],
      forms: [
    ...
    },
    {
      ...
      details: { timezone: 'WIB', method: 'Online', scheme: 'Sosial', duration: 2000, category: 'Publikasi Ilmiah', grade_level: 'Semua', organizer: 'HRP Insight', price: 1500000, participant_count: 40, pic: 'Dewi Lestari', moderator: 'Bayu Pratama', meeting_link: 'https://meet.google.com/dummy005', documentation_url: 'https://drive.hrp-insight.test/accel-paper', description: 'Pelatihan akselerasi penulisan artikel ilmiah untuk publikasi jurnal.' },
      access: ['hrp-ira'],
    ...
    },
    {
      ...
      details: { timezone: 'WIB', method: 'Online', scheme: 'Sosial', duration: 180, category: 'Literasi Keuangan', grade_level: 'Semua', organizer: 'HRP Insight', price: 0, participant_count: 200, pic: 'Bayu Pratama', moderator: 'Rina Kusuma', meeting_link: 'https://youtube.com/live/dummy006', description: 'Kelas terbuka literasi keuangan bagi guru dan tenaga kependidikan.' },
      access: ['hrp-ira'],
    ...
    },
    {
      ...
      details: { timezone: 'WIB', method: 'Offline', scheme: 'Komersil', duration: 1080, category: 'Digitalisasi', grade_level: 'Semua', organizer: 'HRP Insight', price: 1000000, participant_count: 45, pic: 'Rina Kusuma', moderator: 'Angga Saputra', meeting_link: 'https://zoom.us/j/dummy014', content_link: 'https://drive.hrp-insight.test/transformasi', description: 'Kelas pengembangan transformasi digital pembelajaran bagi sekolah mitra.' },
      access: [],
